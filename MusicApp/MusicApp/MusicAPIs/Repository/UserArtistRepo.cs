...
{
    public static class UserArtistRepo
    {
        ...
        internal  static List<Artists> GetCsvArtist(User_Authentication authUser)
        {
            List<Artists> Artists = new List<JSON_Classes.Artists>();
        ...
        internal static List<Artists> GetRestArtists(User_Authentication authUser)
        {
            try
            {
        ...
        /// <returns>List Of Artists</returns>
        internal static List<Artists> CheckSimilarty(List<Artists> Csvlist,User_Authentication userauth)
        {
        ...
        /// <returns></returns>
        internal static bool SetUserFan(string ArtistId, User_Authentication authUser)
        {
            try
            {
